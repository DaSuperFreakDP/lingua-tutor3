...
export const FLASHCARDS: Flashcard[] = [
  ...
  { id: 'v58', italian: 'uscire_v2', italian_alias: 'uscire', english: 'to go out (alt)', type: 'verb', example: 'Usciamo stasera.', exampleTranslation: 'We go out tonight.' },
  ...
  { id: 'v61', italian: 'chiedere_v2', italian_alias: 'chiedere', english: 'to ask (alt)', type: 'verb', example: 'Chiedo informazioni.', exampleTranslation: 'I ask for information.' },
  ...
  { id: 'v86', italian: 'correre_v2', italian_alias: 'correre', english: 'to run (alt)', type: 'verb', example: 'Corri veloce.', exampleTranslation: 'You run fast.' },
